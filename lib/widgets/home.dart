    ...
    child: Column(
        ...
        children: <Widget>[
          ...
          Row(children: [
            ...
            Text('Arijit Singh', style: TextStyle(fontSize: 12.0)),
            Container(width: 10.0,),
            Text('Khamohiyan', style: TextStyle(fontSize: 12.0))]),
        ...
        child: Column(children: [
          Container(
            ...
            child: CachedNetworkImage(
              imageUrl: "https://lh3.googleusercontent.com/a-/AOh14Gj5Fs9S6MSzvHm7FXPYDmExLVo_k5keZZnKQBhKLA=s96-c-rg-br100",
